...
import "./chunk-YGWHWVOE.js";
import {
  ImageState_default
} from "./chunk-2TMY67HJ.js";
import "./chunk-I32RSEEU.js";
import {
...
import {
  Group_default,
  init_Group
} from "./chunk-5YPMYGIW.js";
import {
  Property_default,
  init_Property
} from "./chunk-3XY6MHN2.js";
...
function parseLiteralStyle(style) {
  ...
  Object.keys(fragContext.variables).forEach(function(varName) {
    ...
    if (variable.type === StringType) {
      ...
      callback = () => style.variables[variable.name] ? 1 : 0;
    } else {
      callback = () => style.variables[variable.name];
    }
